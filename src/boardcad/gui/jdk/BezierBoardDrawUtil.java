...
public class BezierBoardDrawUtil {
	...
	public static void paintPath(AbstractDraw d, double offsetX, double offsetY, double scale, double rotation, Color color, Stroke stroke, GeneralPath path, boolean fill) {
		if (path == null)
			return;
	...
	public static void fillPath(AbstractDraw d, double offsetX, double offsetY, double scale, double rotation, Color color, Stroke stroke, GeneralPath path) {
		if (path == null)
			return;
	...
	public static void paintBezierSplines(AbstractDraw d, double offsetX, double offsetY, double scale, double rotation, Color color, Stroke stroke, BezierSpline[] splines, int DrawControl,
		...
		paintPath(d, offsetX, offsetY, scale, 0.0, color, stroke, path, fill);
	...
	public static void paintBezierControlPoints(AbstractDraw d, double offsetX, double offsetY, double scale, double rotation, Stroke stroke, BezierSpline mPoints,
			ArrayList<BezierKnot> mSelectedControlPoints, boolean flipX, boolean flipY) {
		if (mPoints == null)
			return;
		...
		for (int i = 0; i < mPoints.getNrOfControlPoints(); i++) {
			...
			if (isControlPointSelected && mSelectedControlPoints.size() == 1 && BoardCAD.getInstance().getCurrentCommand().getClass().getName().compareTo(BrdEditCommand.class.getName()) == 0) {
				whichControlPointSelected = ((BrdEditCommand) BoardCAD.getInstance().getCurrentCommand()).getWhich();
			} else {
	...
	public static void paintBezierControlPoints(AbstractDraw d, double offsetX, double offsetY, double scale, double rotation, Stroke stroke, BezierSpline[] splines,
			ArrayList<BezierKnot> mSelectedControlPoints, boolean flipX, boolean flipY) {
		if (splines == null)
			return;

		for (int i = 0; i < splines.length; i++) {
			paintBezierControlPoints(d, offsetX, offsetY, scale, rotation, stroke, splines[i], mSelectedControlPoints, flipX, flipY);
		}

	}

	public static void paintGuidePoints(AbstractDraw d, double offsetX, double offsetY, double scale, double rotation, Color color, Stroke stroke, ArrayList<Point2D.Double> guidePoints,
	...
	public static void paintFins(AbstractDraw d, double offsetX, double offsetY, double scale, double rotation, Color color, Stroke stroke, double[] finCoords, boolean flipX, boolean flipY) {
		AffineTransform savedTransform = BezierBoardDrawUtil.setTransform(d, offsetX, offsetY, scale, rotation);
		...
		// x, y for back of fin, x,y for front of fin, bac of center, front of
		// center, depth of center, depth of sidefin, splay angle
	...
	double offsetY, double scale, double rotation, Color color, Stroke stroke, Point2D.Double pos, boolean flipX, boolean flipY) {
	...
	public static void paintGrid(AbstractDraw d, double offsetX, double offsetY, double scale, double rotation, Color color, double verticalToCover, double horizontalToCover, boolean flipX,
			boolean flipY) {

		switch (UnitUtils.getCurrentUnit()) {
		case UnitUtils.CENTIMETERS:
		case UnitUtils.MILLIMETERS:
			paintGridMetric(d, offsetX, offsetY, scale, rotation, color, verticalToCover, horizontalToCover, flipX, flipY);
			break;
		case UnitUtils.INCHES:
		case UnitUtils.INCHES_DECIMAL:
			paintGridImperial(d, offsetX, offsetY, scale, rotation, color, verticalToCover, horizontalToCover, flipX, flipY);
			break;
		}
	}

	private static void paintGridMetric(AbstractDraw d, double offsetX, double offsetY, double scale, double rotation, Color color, double verticalToCover, double horizontalToCover, boolean flipX,
			boolean flipY) {
	...
	private static void paintGridImperial(AbstractDraw d, double offsetX, double offsetY, double scale, double rotation, Color color, double verticalToCover, double horizontalToCover, boolean flipX,
			boolean flipY) {
	...
	public static void paintCurvature(AbstractDraw d, double offsetX, double offsetY, double scale, double rotation, Color color, Stroke stroke, BezierSpline bezierSpline, boolean flipX,
			boolean flipY, double curvature_scale) {
		...
		// paintCurvatureByPos( 0,bezierPath.getMaxX(), flipX,
		// flipY,curvature_scale);

		resetTransform(d, savedTransform);
	}

	public static void paintCurvature(AbstractDraw d, double offsetX, double offsetY, double scale, double rotation, Color color, Stroke stroke, BezierSpline[] splines, boolean flipX, boolean flipY,
			double curvature_scale) {
		if (splines == null)
			return;

		for (int i = 0; i < splines.length; i++) {
			paintCurvature(d, offsetX, offsetY, scale, rotation, color, stroke, splines[i], flipX, flipY, curvature_scale);
		}

	}

	public static void paintVolumeDistribution(AbstractDraw d, double offsetX, double offsetY, double scale, double rotation, Color color, Stroke stroke, BezierBoard brd, boolean flipX,
			boolean flipY, double graph_scale) {
		if (brd == null)
			return;
	...
	public static void paintOutlineFlowLines(AbstractDraw d, double offsetX, double offsetY, double scale, double rotation, Color color, Stroke stroke, BezierBoard brd, boolean flipX, boolean flipY) {
		if (brd == null)
			return;
	...
	public static void paintOutlineTuckUnderLine(AbstractDraw d, double offsetX, double offsetY, double scale, double rotation, Color color, Stroke stroke, BezierBoard brd, boolean flipX,
			boolean flipY) {
		if (brd == null)
			return;
	...
	public static void paintProfileFlowLines(AbstractDraw d, double offsetX, double offsetY, double scale, double rotation, Color color, Stroke stroke, BezierBoard brd, boolean flipX, boolean flipY) {
		if (brd == null)
			return;
	...
	public static void paintProfileApexline(AbstractDraw d, double offsetX, double offsetY, double scale, double rotation, Color color, Stroke stroke, BezierBoard brd, boolean flipX, boolean flipY) {
		paintProfileApexLine(d, offsetX, offsetY, scale, rotation, color, stroke, brd, flipX, flipY);
	}
	...
	public static void paintProfileTuckUnderLine(AbstractDraw d, double offsetX, double offsetY, double scale, double rotation, Color color, Stroke stroke, BezierBoard brd, boolean flipX,
			boolean flipY) {
		if (brd == null)
			return;
	...
	public static void paintCrossSectionCenterline(AbstractDraw d, double offsetX, double offsetY, double scale, double rotation, Color color, Stroke stroke, BezierBoard brd, boolean flipY,
	...
	public static void paintCrossSectionFlowLines(AbstractDraw d, double offsetX, double offsetY, double scale, double rotation, Color color, Stroke stroke, BezierBoard brd, boolean flipY,
			boolean flattenRocker) {
		if (brd == null)
			return;
	...
	public static void paintCrossSectionApexline(AbstractDraw d, double offsetX, double offsetY, double scale, double rotation, Color color, Stroke stroke, BezierBoard brd, boolean flipY,
			boolean flattenRocker) {
		if (brd == null)
			return;
	...
	public static void paintCrossSectionTuckUnderLine(AbstractDraw d, double offsetX, double offsetY, double scale, double rotation, Color color, Stroke stroke, BezierBoard brd, boolean flipY,
			boolean flattenRocker) {
		if (brd == null)
			return;
	...
	static void paintCurvatureByT(AbstractDraw d, BezierCurve curve, double t0, double t1, boolean flipX, boolean flipY, double scale) {
		...
		if (Double.isInfinite(chord) || Double.isInfinite(length) || Double.isNaN(chord) || Double.isNaN(length))
			return;
	...
	public static void paintSlidingCrossSection(AbstractDraw d, double offsetX, double offsetY, double scale, double rotation, Color color, Stroke stroke, boolean flipX, boolean flipY, double pos,
			BezierBoard brd) {
		if (brd.getCrossSections().size() <= 2)
			return;

		// DEBUG
		// paintSlidingCrossSectionNormals(d, offsetX, offsetY, scale, rotation,
		// color,
		// stroke, flipX, flipY, pos, brd);

		switch (BoardCAD.getInstance().getCrossSectionInterpolationType()) {
		case LinearInterpolation:
			paintSlidingCrossSectionBlendInterpolation(d, offsetX, offsetY, scale, rotation, color, stroke, flipX, flipY, pos, brd);
			break;
		case ControlPointInterpolation:
			paintSlidingCrossSectionControlPointInterpolation(d, offsetX, offsetY, scale, rotation, color, stroke, flipX, flipY, pos, brd);
			break;
		case SLinearInterpolation:
			// paintSlidingCrossSectionBlendFromSInterpolation(d, offsetX,
			// offsetY, scale, rotation, color, stroke, flipX, flipY, pos, brd);
			paintSlidingCrossSectionBlendFromSInterpolationSep(d, offsetX, offsetY, scale, rotation, color, stroke, flipX, flipY, pos, brd);
			break;
		default: // DEBUG
			paintSlidingCrossSectionBlendInterpolation(d, offsetX, offsetY, scale, rotation, new Color(255, 0, 0), stroke, flipX, flipY, pos, brd);
			paintSlidingCrossSectionControlPointInterpolation(d, offsetX, offsetY, scale, rotation, new Color(0, 255, 0), stroke, flipX, flipY, pos, brd);
			paintSlidingCrossSectionBlendFromSInterpolationSep(d, offsetX, offsetY, scale, rotation, new Color(0, 0, 255), stroke, flipX, flipY, pos, brd);
			break;
	...
	public static void paintSlidingCrossSectionNormals(AbstractDraw d, double offsetX, double offsetY, double scale, double rotation, Color color, Stroke stroke, boolean flipX, boolean flipY,
			double pos, BezierBoard brd) {
	...
	/*
	 * public static void
	 * paintSlidingCrossSectionBlendFromSInterpolation(AbstractDraw d, double
	...
	public static void paintSlidingCrossSectionBlendFromSInterpolationSep(AbstractDraw d, double offsetX, double offsetY, double scale, double rotation, Color color, Stroke stroke, boolean flipX,
			boolean flipY, double pos, BezierBoard brd) {
		...
		for (int w = 0; w < 3; w++) {
			...
			path.moveTo(point.y, point.z);
			double steps = 20;
			for (int i = 1; i <= steps; i++) {
				point = AbstractBezierBoardSurfaceModel.getBezierBoardSurfaceModel(AbstractBezierBoardSurfaceModel.ModelType.SLinearInterpolation).getPointAt(mBrd, pos, i / steps, a0, a1, true);
				point.z -= rocker;
				path.lineTo(point.y, point.z);
	...
	/*
	 * public static void paintSlidingCrossSectionBlendFromSInterpolation(double
	 ...
	 * paintSlidingCrossSectionBlendFromSInterpolation(pos, ss, s1); } else {
	 * /*Draw Normal for debug Vector3d vec = mBrd.getNormalAtPos(pos, ss);
	 * ls.setLine(ps.x*mMulX, ps.y*mMulY,(ps.x+vec.y)*mMulX,
	 * (ps.y+vec.z)*mMulY); ds.draw(ls);
	 */
	/*
	 * ls.setLine(p0.x*mMulX, p0.y*mMulY, ps.x*mMulX, ps.y*mMulY); ds.draw(ls);
	...
	public static void paintSlidingCrossSectionControlPointInterpolation(AbstractDraw d, double offsetX, double offsetY, double scale, double rotation, Color color, Stroke stroke, boolean flipX,
		...
		if (interpol != null) {
			BezierBoardDrawUtil.paintBezierSpline(d, offsetX, offsetY, scale, rotation, color, stroke, interpol.getBezierSpline(), ((flipX == true) ? BezierBoardDrawUtil.FlipX : 0)
					| ((flipY == true) ? BezierBoardDrawUtil.FlipY : 0), true);
			BezierBoardDrawUtil.paintBezierSpline(d, offsetX, offsetY, scale, rotation, color, stroke, interpol.getBezierSpline(), ((flipX == true) ? 0 : BezierBoardDrawUtil.FlipX)
					| ((flipY == true) ? BezierBoardDrawUtil.FlipY : 0), true);
			// DEBUG BrdDrawUtil.paintBezierControlPoints(d,offsetX, offsetY,
			// scale, stroke, interpol.mCrossSectionControlPoints, new
			// ArrayList<ControlPoint>(), flipX, flipY); //DEBUG!
		}

	}

	public static void paintSlidingCrossSectionBlendInterpolation(AbstractDraw d, double offsetX, double offsetY, double scale, double rotation, Color color, Stroke stroke, boolean flipX,
			boolean flipY, double pos, BezierBoard brd) {
		...
		ls.setLine(halfWidth, z0, halfWidth, z1);
		d.draw(ls);
		ls.setLine(-halfWidth, z0, -halfWidth, z1);
		d.draw(ls);
	...
	public static void paintSlidingCrossSectionBlendInterpolation(AbstractDraw d, double x, double y0, double y1) {
		...
		if (Math.abs(y1 - y0) > SLIDING_CROSS_MIN_SPLIT
				&& (chord > SLIDING_CROSS_SECTION_MAX_LINE_LENGTH || (Math.abs(length - chord) > SLIDING_CROSS_SECTION_TOLERANCE && chord > SLIDING_CROSS_SECTION_MIN_LINE_LENGTH))) {
			paintSlidingCrossSectionBlendInterpolation(d, x, y0, ys);
			paintSlidingCrossSectionBlendInterpolation(d, x, ys, y1);
		} else {
			ls.setLine(y0, z0, ys, zs);
			d.draw(ls);
			ls.setLine(ys, zs, y1, z1);
			d.draw(ls);
			ls.setLine(-y0, z0, -ys, zs);
			d.draw(ls);
			ls.setLine(-ys, zs, -y1, z1);
	...
	public static void paintDetails(AbstractDraw d, double offsetX, double offsetY, double scale, double rotation, Color color, Stroke stroke, BezierSpline[] beziers, boolean flipX, boolean flipY,
			boolean mirrorX, boolean mirrorY, double posOffsetX, double posOffsetY, double measurementOffsetX, double measurementOffsetY) {
		for (int i = 0; i < beziers.length; i++) {
			paintBezierSpline(d, offsetX, offsetY, scale, rotation, color, stroke, beziers[i], ((flipX == true) ? BezierBoardDrawUtil.FlipX : 0) | ((flipY == true) ? BezierBoardDrawUtil.FlipY : 0)
					| ((mirrorX == true) ? BezierBoardDrawUtil.MirrorX : 0) | ((mirrorY == true) ? BezierBoardDrawUtil.MirrorY : 0), true);
		}
	}

	public static void paintDetailsVertical(AbstractDraw d, double offsetX, double offsetY, double scale, double rotation, Color color, Stroke stroke, BezierSpline[] beziers, boolean flipX,
			boolean flipY, boolean mirrorX, boolean mirrorY, double posOffsetX, double posOffsetY, double measurementOffsetX, double measurementOffsetY) {
		for (int i = 0; i < beziers.length; i++) {
			paintBezierSpline(d, offsetX, offsetY, scale, Math.PI / 4.0, color, stroke, beziers[i], ((flipX == true) ? BezierBoardDrawUtil.FlipX : 0)
					| ((flipY == true) ? BezierBoardDrawUtil.FlipY : 0) | ((mirrorX == true) ? BezierBoardDrawUtil.MirrorX : 0) | ((mirrorY == true) ? BezierBoardDrawUtil.MirrorY : 0), true);
		}
	}

	static public AffineTransform setTransform(AbstractDraw d, double offsetX, double offsetY, double scale, double rotation) {
	...
	public static AffineTransform setTransform(AbstractDraw d, double offsetX, double offsetY, double scale, double rotation, boolean mirrorX, boolean mirrorY) {
		...
		if (scale == 0.0) {
			System.out.println("Error, scale is 0.0");
		}

		at.scale(scale * (mirrorX ? -1.0 : 1.0), scale * (mirrorY ? -1.0 : 1.0));
	...
	// Old functions originating from printing
	...
	double offsetY, double scale, double rotation, boolean paintGrid, BezierBoard brd, boolean printGuidePoints, boolean printFins) {
		...
		if (printFins == true) {
			BezierBoardDrawUtil.paintFins(d, offsetX, offsetY, scale, rotation, Color.GRAY, stroke, brd.getFins(), false, false);
		}
	}

	public static void printOutlineOverCurve(AbstractDraw d, double offsetX, double offsetY, double scale, double rotation, boolean paintGrid, BezierBoard brd, boolean printGuidePoints,
			boolean printFins, boolean mirrorX, boolean mirrorY) {
		...
		if (paintGrid) {
			paintGrid(d, offsetX, offsetY, scale, rotation, new Color(128, 128, 128), brd.getLength(), brd.getMaxWidth() / 2.0, false, false);
		}
		...
		// paintBezierSpline(d,offsetX, offsetY, scale,
	...
	double offsetY, double scale, double rotation, boolean paintGrid, BezierBoard brd, boolean printGuidePoints, boolean printFins) {
		...
		printOutlineOverCurve(d, offsetX, offsetY, scale, rotation, false, brd, printGuidePoints, printFins, false, false);
		...
		printOutlineOverCurve(d, offsetX - xOffset, offsetY + yOffset, scale, rotation + rotationOffset, false, brd, printGuidePoints, printFins, false, true);
	...
	double offsetY, double scale, double rotation, boolean paintGrid, BezierBoard brd, Boolean printGuidePoints) {
		...
		if (paintGrid)
			paintGrid(d, offsetX, offsetY, scale, rotation, new Color(128, 128, 128), brd.getLength(), brd.getMaxRocker() / 2.0, false, false);
		...
		if (printGuidePoints == true) {
			...
			BezierBoardDrawUtil.paintGuidePoints(d, offsetX, offsetY, scale, rotation, Color.GRAY, stroke, brd.getBottomGuidePoints(), false, false);
		}
	}

	// Old functions orginating from printing
	public static void printSlice(AbstractDraw d, double offsetX, double offsetY, double scale, double rotation, boolean paintGrid, BezierBoard brd, int i, boolean printGuidePoints) {
		...
		if (paintGrid)
			paintGrid(d, offsetX, offsetY, scale, rotation, new Color(128, 128, 128), crs.getWidth(), crs.getCenterThickness(), false, false);
	...
	// Old functions orginating from printing
	public static void printRailTemplate(AbstractDraw d, double offsetX, double offsetY, double scale, double rotation, boolean paintGrid, BezierBoard brd, double distanceFromRail,
			double skinThickness, double tailOffset, double noseOffset, boolean flatten) {
		...
		for (; i <= steps; i++) {
			...
			double deck = getDeckWithSkinCompensation(brd, x, y, skinThickness);
			double bottom = getBottomWithSkinCompensation(brd, x, y, skinThickness);

			// System.out.printf("printRailTemplate ox: %f oy: %f Normal: %f x: %f y: %f Deck: %f Bottom: %f\n",
			// ox,oy,normalAngle/MathUtils.DEG_TO_RAD, x,y, deck, bottom);
		...
		System.out.printf("Rail tip of nose pos at %f, deck:%f bottom:%f\n", ox, lastDeck, lastBottom);
	...
	// Old functions orginating from printing
	public static void printDeckSkinTemplate(AbstractDraw d, double offsetX, double offsetY, double scale, double rotation, boolean paintGrid, BezierBoard brd, double distanceFromRail) {
		...
		// paintGrid(d, offsetX, offsetY, scale, new Color(128,128,128),
		// verticalLines, horizontalLines, false, false);
		...
		for (double ox = 0; ox < brd.getLength(); ox += step) {
			...
			// Find the width of the template at this point accounting for over
			// curve
			double width = 0;
	...
	// Old functions orginating from printing
	public static void printBottomSkinTemplate(AbstractDraw d, double offsetX, double offsetY, double scale, double rotation, boolean paintGrid, BezierBoard brd, double distanceFromRail) {
		if (brd.isEmpty()) {
	...
	public static void printCrossSection(AbstractDraw d, double offsetX, double offsetY, double scale, double rotation, boolean paintGrid, BezierBoard brd, double position) {
		if (brd.isEmpty()) {
	...
	// Old functions orginating from printing
	public static void printCrossSection(AbstractDraw d, double offsetX, double offsetY, double scale, double rotation, boolean paintGrid, BezierBoard brd, double position, double railOffset,
	...
	// Old functions orginating from printing
	public static void printProfile(AbstractDraw d, double offsetX, double offsetY, double scale, double rotation, boolean paintGrid, BezierBoard brd, double offset, double skinThickness,
			boolean flatten, double tailOffset, double noseOffset) {
		printProfile(d, new Color(0, 0, 0), 2.0, offsetX, offsetY, scale, rotation, paintGrid, brd, offset, skinThickness, flatten, tailOffset, noseOffset);
	}

	// Old functions orginating from printing
	public static void printProfile(AbstractDraw d, Color color, double lineWidth, double offsetX, double offsetY, double scale, double rotation, boolean paintGrid, BezierBoard brd, double offset,
			double skinThickness, boolean flatten, double tailOffset, double noseOffset) {
		if (brd.isEmpty()) {
			return;
		}
		...
		for (int i = 0; i <= steps; i++) {
			...
			// Find thickness and rocker at pos
			double deck = (skinThickness != 0.0) ? getDeckWithSkinCompensation(brd, x, y, skinThickness) : brd.getDeckAt(x, y);

			double bottom = (skinThickness != 0.0) ? getBottomWithSkinCompensation(brd, x, y, skinThickness) : brd.getBottomAt(x, y);
			if (flatten) {
				double deckRockerCompensation = brd.getDeck().getValueAt(x) - brd.getThickness();
				deck -= deckRockerCompensation;
				bottom -= deckRockerCompensation;
			...
			// System.out.printf("Profile x: %f y: %f Deck: %f Bottom: %f\n",
			// x,y, deck, bottom);
			if (bottom >= deck) {
				// System.out.printf("Profile bottom >= deck, skinThickness:%f x: %f y: %f Deck: %f Bottom: %f\n",
				// skinThickness, x,y, deck, bottom);
				bottom = (skinThickness != 0.0) ? getBottomWithSkinCompensation(brd, x, y, skinThickness) : brd.getBottomAt(x, y);
				deck = (skinThickness != 0.0) ? getDeckWithSkinCompensation(brd, x, y, skinThickness) : brd.getDeckAt(x, y);
				if (first) {
					path.moveTo(x, deck);
				} else {
					break;
	...
	public static void paintFunction(AbstractDraw d, double offsetX, double offsetY, double scale, double rotation, Color color, Stroke stroke, Function func, double minLimit, double maxLimit,
	...
	public static double getDeckWithSkinCompensation(AbstractBoard board, double x, double y, double skinThickness) {
		// Find thickness and rocker at pos
	...
	public static double getBottomWithSkinCompensation(AbstractBoard board, double x, double y, double skinThickness) {
		...
		double bottomSkinCompensation = skinThickness / Math.cos(normalAngle);

		// System.out.printf("getBottomWithSkinCompensation() bottom: %f, skinThickness:%f normal: %f, %f, %f normalAngle: %f\n",
		// bottom, skinThickness, bottomNormal.x,bottomNormal.y,bottomNormal.z,
		// normalAngle);
	...
	public static boolean hasMoveTo(GeneralPath path) {
