		...
		if (pageIndex < widthInPages*heightInPages) {
			...
			if(mOverCurve)
			{
				BezierBoardDrawUtil.printOutlineOverCurve(new JavaDraw(g2d),
						...
						-pageFormat.getImageableHeight()*(pageIndex/widthInPages), 72/2.54, 0.0, mPrintGrid ,BoardCAD.getInstance().getCurrentBrd(), BoardCADSettings.getInstance().isPrintingControlPoints(),BoardCADSettings.getInstance().isPrintingFins(), false, false);
			}
			else
			{
				BezierBoardDrawUtil.printOutline(new JavaDraw(g2d),
						...
						-pageFormat.getImageableHeight()*(pageIndex/widthInPages), 72/2.54, 0.0, mPrintGrid ,BoardCAD.getInstance().getCurrentBrd(),BoardCADSettings.getInstance().isPrintingControlPoints(),BoardCADSettings.getInstance().isPrintingFins());
			}
		...
		if (pageIndex < widthInPages*heightInPages) {
			...
			if(mOverCurve)
			{
				BezierBoardDrawUtil.printSpinTemplateOverCurve(new JavaDraw(g2d),
						-pageFormat.getImageableWidth()*(pageIndex%widthInPages),
						-pageFormat.getImageableHeight()*(pageIndex/widthInPages), 72/2.54, 0.0, mPrintGrid,brd,BoardCADSettings.getInstance().isPrintingControlPoints(),BoardCADSettings.getInstance().isPrintingFins());
			}
			else
			{
	...
	int printProfile(PageFormat pageFormat, int pageIndex, Graphics g)
	{
		...
		if (pageIndex < widthInPages*heightInPages) {
			...
			BezierBoardDrawUtil.printProfile(new JavaDraw(g2d),
					...
					-pageFormat.getImageableHeight()*(pageIndex/widthInPages), 72/2.54, 0.0, true, BoardCAD.getInstance().getCurrentBrd(),BoardCADSettings.getInstance().isPrintingControlPoints());
	...
	int printSlices(PageFormat pageFormat, int pageIndex, Graphics g)
	{
		...
		if (pageIndex < totalWidthInPages*heightInPages) {
			...
			BezierBoardDrawUtil.printSlice(new JavaDraw(g2d),
					...
					pageIndex/widthPrSliceInPages + 1,BoardCADSettings.getInstance().isPrintingControlPoints());
